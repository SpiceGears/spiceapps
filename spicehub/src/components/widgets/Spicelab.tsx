      ...
      <div className="p-4">
        <div className="flex items-center justify-between text-gray-900 dark:text-gray-100">
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-xs text-gray-600 dark:text-gray-400">Nierobione zadania</div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-xs text-gray-600 dark:text-gray-400">Ważne projekty</div>
              <div className="font-medium text-gray-900 dark:text-gray-100">1</div>
            </div>
          </div>
          <Link href="/spicelab">
